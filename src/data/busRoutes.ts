...
export const BUS_VEHICLES: BusVehicle[] = [
  {
    ...
    driverRating: 4.9,
    busImage: 'https://images.unsplash.com/photo-1618847791039-886c74c001ad?auto=format&fit=crop&q=80&w=800',
    capacity: 52,
    currentOccupancy: 36,
    hasAC: true,
    isLive: true,
  ...
  },
  {
    ...
    driverRating: 4.8,
    busImage: 'https://images.unsplash.com/photo-1706017272776-89e19de79a97?auto=format&fit=crop&q=80&w=800',
    capacity: 48,
    currentOccupancy: 39,
    hasAC: true,
    isLive: true,
  ...
  },
  {
    ...
    driverRating: 4.9,
    busImage: 'https://images.unsplash.com/photo-1550523049-a61d0deec4a4?auto=format&fit=crop&q=80&w=800',
    capacity: 45,
    currentOccupancy: 28,
    hasAC: false,
    isLive: true,
  ...
  },
  {
    ...
    driverRating: 4.7,
    busImage: 'https://images.unsplash.com/photo-1570125909232-eb263c188f7e?auto=format&fit=crop&q=80&w=800',
    capacity: 52,
    currentOccupancy: 44,
    hasAC: true,
    isLive: true,
