...
export const BUS_VEHICLES: BusVehicle[] = [
  {
    ...
    driverRating: 4.9,
    busImage: 'https://images.unsplash.com/photo-1580674285054-bed31e145f59?auto=format&fit=crop&q=80&w=800',
    capacity: 52,
    currentOccupancy: 36,
    hasAC: true,
    isLive: true,
  ...
  },
  {
    ...
    driverRating: 4.7,
    busImage: 'https://images.unsplash.com/photo-1546751706-81c567470489?auto=format&fit=crop&q=80&w=800',
    capacity: 52,
    currentOccupancy: 44,
    hasAC: true,
    isLive: true,
