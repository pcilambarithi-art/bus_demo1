...
export const BUS_VEHICLES: BusVehicle[] = [
  ...
  },
  {
    ...
    busImage: 'https://images.unsplash.com/photo-1494515843206-f3117d3f51b7?auto=format&fit=crop&q=80&w=800',
    capacity: 45,
    currentOccupancy: 28,
    hasAC: false,
    isLive: true,
  ...
  },
  {
    ...
    busImage: 'https://images.unsplash.com/photo-1557223562-6c77ef16210f?auto=format&fit=crop&q=80&w=800',
    capacity: 52,
    currentOccupancy: 44,
    hasAC: true,
    isLive: true,
