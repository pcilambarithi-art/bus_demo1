  ...
  return (
    <div
      ...
      className={`
        ...
        bg-white/85 border-slate-200/90 shadow-[0_8px_30px_0_rgba(15,23,42,0.06)]
        border
        /* Top specular reflection highlight */
        before:content-[''] before:absolute before:top-0 before:left-0 before:right-0 before:h-[1px]
        before:bg-gradient-to-r before:from-transparent dark:before:via-white/30 before:via-cyan-500/20 before:to-transparent before:pointer-events-none
